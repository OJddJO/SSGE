...
Copyright (C) 2012-2014  Andreas Schiffler - modified by OJddJO
...
#  define SDL2_GFXPRIMITIVES_SCOPE extern
	...
	SDL2_GFXPRIMITIVES_SCOPE int thickEllipseRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Uint8 thick);
